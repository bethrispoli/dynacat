function params = dynacat_initDefaultParams
...
% inplanes
defaultInplanePath = fullfile(params.sessionDir, 'Inplane');
if exist(defaultInplanePath, 'dir')
    % look for DICOM files
    pattern = fullfile(defaultInplanePath, '*.nii.gz');
...
% functionals
defaultFuncPath1 = fullfile(params.sessionDir, 'functionals');
...
% % volume anatomy --- dont have 3D anats right now bc of server shutdown
